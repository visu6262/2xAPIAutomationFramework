...
def test_create_auth_from_xlsx():
    filepath=r"C:\Users\91939\PycharmProjects\2xAPIAutomationFramework\tests\test\datadriventesting\testdata.xlsx"
    credentials=read_credentials_from_xlsx(file_name_or_path=filepath)
    # print("\n printing 2",credentials)
    print(json.dumps(credentials,indent=3))
    for uidpwd in credentials:
